 ...
 * Deployed: 2026-01-20 01:57 IST (Build v7 - @sparticuz/chromium clean)
 */

console.log('[Serverless Init] === DEPLOYMENT BUILD v7 ===');
...
console.log('[Serverless Init] Using @sparticuz/chromium for PDF generation');
